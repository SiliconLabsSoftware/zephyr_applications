...
lv_obj_t * ui_ApplicationScreen = NULL;
lv_obj_t * ui_Bar1 = NULL;
lv_obj_t * ui_imgbthome = NULL;
lv_obj_t * ui_imglvgl = NULL;
lv_obj_t * ui_imgsilabs = NULL;
lv_obj_t * ui_imgzephyr = NULL;
lv_obj_t * ui_labeltextSi7021 = NULL;
lv_obj_t * ui_labelTempValue = NULL;
lv_obj_t * ui_labelcelciousSymbol = NULL;
lv_obj_t * ui_labelhumidityValue = NULL;
lv_obj_t * ui_labelhumiditypercent = NULL;
lv_obj_t * ui_labelVEML6035 = NULL;
lv_obj_t * ui_labelSI7210Hall = NULL;
lv_obj_t * ui_labelBMP384Barometric = NULL;
lv_obj_t * ui_Bar2 = NULL;
lv_obj_t * ui_labelICM20689 = NULL;
lv_obj_t * ui_labelVEMLAmbientLightValue = NULL;
lv_obj_t * ui_labellxsymbol = NULL;
lv_obj_t * ui_labelsi7210HallEffectValue = NULL;
lv_obj_t * ui_labelmTSymbol = NULL;
lv_obj_t * ui_labelBMP384Value = NULL;
lv_obj_t * ui_labelmBarSymbol = NULL;
lv_obj_t * ui_labelOrientation = NULL;
lv_obj_t * ui_labelorientXvalue = NULL;
lv_obj_t * ui_Bar3 = NULL;
lv_obj_t * ui_labelDegreesymbol1 = NULL;
lv_obj_t * ui_labelorientYvalue = NULL;
lv_obj_t * ui_labelDegreesymbol2 = NULL;
lv_obj_t * ui_labelorientZvalue = NULL;
lv_obj_t * ui_labelDegreesymbol3 = NULL;
lv_obj_t * ui_labelAcceleration = NULL;
lv_obj_t * ui_labelg1Value = NULL;
lv_obj_t * ui_labelGSymbol1 = NULL;
lv_obj_t * ui_labelg2Value = NULL;
lv_obj_t * ui_labelGSymbol2 = NULL;
lv_obj_t * ui_labelg3Value = NULL;
lv_obj_t * ui_labelGSymbol3 = NULL;
lv_obj_t * ui_labelxg24 = NULL;
lv_obj_t * ui_Bar4 = NULL;
lv_obj_t * ui_labelbroadcasted = NULL;
lv_obj_t * ui_labelsecond = NULL;
lv_obj_t * ui_labelsecago = NULL;
// event funtions
...
void ui_ApplicationScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_ApplicationScreen, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_imgbthome = lv_image_create(ui_ApplicationScreen);
    lv_image_set_src(ui_imgbthome, &ui_img_25_png);
    ...
    lv_obj_remove_flag(ui_imgbthome, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_imglvgl = lv_image_create(ui_ApplicationScreen);
    lv_image_set_src(ui_imglvgl, &ui_img_lvgl_logo_78_24_png);
    ...
    lv_obj_remove_flag(ui_imglvgl, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_imgsilabs = lv_image_create(ui_ApplicationScreen);
    lv_image_set_src(ui_imgsilabs, &ui_img_30_60_png);
    ...
    lv_obj_remove_flag(ui_imgsilabs, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_imgzephyr = lv_image_create(ui_ApplicationScreen);
    lv_image_set_src(ui_imgzephyr, &ui_img_35_67_png);
    ...
    lv_obj_remove_flag(ui_imgzephyr, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelTempValue, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelorientXvalue, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelorientYvalue, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelorientZvalue, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelg1Value, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelg2Value, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelg3Value, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_labelsecond, LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
void ui_ApplicationScreen_screen_destroy(void)
{
    if(ui_ApplicationScreen) lv_obj_del(ui_ApplicationScreen);

    // NULL screen variables
    ui_ApplicationScreen = NULL;
    ui_Bar1 = NULL;
    ui_imgbthome = NULL;
    ui_imglvgl = NULL;
    ui_imgsilabs = NULL;
    ui_imgzephyr = NULL;
    ui_labeltextSi7021 = NULL;
    ui_labelTempValue = NULL;
    ui_labelcelciousSymbol = NULL;
    ui_labelhumidityValue = NULL;
    ui_labelhumiditypercent = NULL;
    ui_labelVEML6035 = NULL;
    ui_labelSI7210Hall = NULL;
    ui_labelBMP384Barometric = NULL;
    ui_Bar2 = NULL;
    ui_labelICM20689 = NULL;
    ui_labelVEMLAmbientLightValue = NULL;
    ui_labellxsymbol = NULL;
    ui_labelsi7210HallEffectValue = NULL;
    ui_labelmTSymbol = NULL;
    ui_labelBMP384Value = NULL;
    ui_labelmBarSymbol = NULL;
    ui_labelOrientation = NULL;
    ui_labelorientXvalue = NULL;
    ui_Bar3 = NULL;
    ui_labelDegreesymbol1 = NULL;
    ui_labelorientYvalue = NULL;
    ui_labelDegreesymbol2 = NULL;
    ui_labelorientZvalue = NULL;
    ui_labelDegreesymbol3 = NULL;
    ui_labelAcceleration = NULL;
    ui_labelg1Value = NULL;
    ui_labelGSymbol1 = NULL;
    ui_labelg2Value = NULL;
    ui_labelGSymbol2 = NULL;
    ui_labelg3Value = NULL;
    ui_labelGSymbol3 = NULL;
    ui_labelxg24 = NULL;
    ui_Bar4 = NULL;
    ui_labelbroadcasted = NULL;
    ui_labelsecond = NULL;
    ui_labelsecago = NULL;
