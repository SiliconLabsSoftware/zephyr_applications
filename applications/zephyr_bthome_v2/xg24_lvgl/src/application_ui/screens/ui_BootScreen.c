...
void ui_BootScreen_screen_init(void)
{
    ...
    ui_imgsilabsbig = lv_image_create(ui_BootScreen);
    lv_image_set_src(ui_imgsilabsbig, &ui_img_1597985048);
    ...
    lv_obj_remove_flag(ui_imgsilabsbig, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
