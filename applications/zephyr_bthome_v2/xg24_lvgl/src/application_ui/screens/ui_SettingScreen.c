...
lv_obj_t * ui_labelSetting = NULL;
lv_obj_t * ui_btnback = NULL;
lv_obj_t * ui_LabelBack = NULL;
lv_obj_t * ui_labelBoardcastenable = NULL;
lv_obj_t * ui_labelDeviceName = NULL;
lv_obj_t * ui_labelboardcastperiod = NULL;
lv_obj_t * ui_labelencryptkey = NULL;
lv_obj_t * ui_Keyboard1 = NULL;
lv_obj_t * ui_txtdevicename = NULL;
lv_obj_t * ui_txtboardcastperiod = NULL;
lv_obj_t * ui_txtencryptkey = NULL;
lv_obj_t * ui_swboardcastenable = NULL;
// event funtions
...
void ui_SettingScreen_screen_init(void)
{
    ...
    ui_imgBTHome = lv_image_create(ui_SettingScreen);
    ...
    lv_obj_remove_flag(ui_imgBTHome, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_btnback = lv_button_create(ui_SettingScreen);
...
void ui_SettingScreen_screen_destroy(void)
{
    ...
    ui_Bar5 = NULL;
    ui_imgBTHome = NULL;
    ui_labelSetting = NULL;
    ui_btnback = NULL;
    ui_LabelBack = NULL;
    ui_labelBoardcastenable = NULL;
    ui_labelDeviceName = NULL;
    ui_labelboardcastperiod = NULL;
    ui_labelencryptkey = NULL;
    ui_Keyboard1 = NULL;
    ui_txtdevicename = NULL;
    ui_txtboardcastperiod = NULL;
    ui_txtencryptkey = NULL;
    ui_swboardcastenable = NULL;
